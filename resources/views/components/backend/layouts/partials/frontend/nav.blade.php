<header id="page-header" class="js-appear-enabled animated fadeInDown" data-toggle="appear" data-class="animated fadeInDown" data-timeout="600">
    <div class="content-header">
        <div class="d-flex align-items-center">
            <a class="link-fx font-size-lg font-w700 text-dark" href="{{ route('frontend.landing') }}">
            ...
            <ul class="nav-main nav-main-horizontal nav-main-hover">
                @guest
                    <li class="nav-main-item">
                        <a class="nav-main-link" data-toggle="scroll-to" data-speed="750" href="{{ route('frontend.login') }}">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link" data-toggle="scroll-to" data-speed="750" href="{{ route('frontend.register') }}">
                ...
                @else
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="{{ route('backend.dashboard') }}">
                    ...
                    <li class="nav-main-item">
                        <x-backend.forms.formLink :action="route('logout')" class="nav-main-link" :id="'logout-form'">
