<x-layouts.backend>
    ...
    <div class="content">
        ...
        <x-elements.card is-div is-rounded is-bordered with-header>
            ...
            <x-elements.form class="mb-5" action="{{route('admin.users.update', ['user' => $user->id])}}" method="PUT" id="frmUserEdit">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="form-row">
                            <x-elements.textbox class="form-group col-md-6" id="username" name="username" type="text" placeholder="Username" value="{{ $user->username }}" isRequired='true'>
                                Username
                            </x-elements.textbox>
                        ...
                        <div class="form-row">
                            <x-elements.textbox class="form-group col-md-12" id="password" name="password" type="password" placeholder="Password">
                                Password
                            </x-elements.textbox>
                        </div>
                        <h2 class="content-heading">Change Password</h2>
                        <div class="form-row">
                            <x-elements.textbox class="form-group col-md-6" id="new_password" name="new_password" type="password" placeholder="New Password">
                                New Password
                            </x-elements.textbox>
                            <x-elements.textbox class="form-group col-md-6" id="password-confirm" name="new_password_confirmation" type="password" placeholder="Confirm Password">
                                Confirm Password
                            </x-elements.textbox>
                        </div>
                    </div>
